/*********************************************************************NVMH3****
File:  $Id: //sw/devtools/FXComposer1.6/SDK/MEDIA/HLSL/post_glowTrailFP.fx#1 $
...
Comments:
	...
	Same as "post_glowTrail.fx" but with FP16 buffers
	$Date: 2004/09/24 $
...
float Script : STANDARDSGLOBAL <
	...
	//string Company = "NVIDIA Corporation";
	//string Copyright = "2004 NVIDIA Corporation";
	//string Author = " $Author: jallen $ ";
...
DECLARE_QUAD_TEX(HBlurMap,HBlurSampler,"A16B16G16R16F")
DECLARE_QUAD_TEX(FinalBlurMap,FinalBlurSampler,"A16B16G16R16F")
...
> {
    ...
    > {
		...
		PixelShader  = compile ps_2_a PS_Blur_Horizontal_9tap();
    }
    pass GlowV <
    ...
    > {
		...
		PixelShader  = compile ps_2_a PS_Blur_Vertical_9tap();
    }
    pass FinalComp <
    ...
    > {
		...
		PixelShader  = compile ps_2_a PS_Comp();
    }
    pass Plop <
    ...
    > {
		...
		AlphaBlendEnable = false;
		VertexShader = compile vs_2_0 ScreenQuadVS();
		PixelShader  = compile ps_2_a TexQuadDimmerPS(BlendSampler,DisplayBright);
    }
}
