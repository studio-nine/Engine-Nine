/*********************************************************************NVMH3****
File:  $Id: //sw/devtools/FXComposer1.6/SDK/MEDIA/HLSL/post_colorGradient.fx#1 $
...
Apply grayscale values to color curve texture -- can be from file
	or procedural, just define CURVE_FILE to use a file
...
float3 GrayConv <
	string UIName = "Grayscale conversion factors (if used)";
> = {.25,.65,.1};
