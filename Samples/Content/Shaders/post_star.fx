/*********************************************************************NVMH3****
File:  $Id: //sw/devtools/FXComposer1.6/SDK/MEDIA/HLSL/post_star.fx#1 $
...
float TexelOffset < string UIWidget="None"; > = 0.5;
			...
			float4 TexCoord : TEXCOORD0)
{
	...
	float4 off = float4(TexelOffset/(ScreenSize.x),TexelOffset/(ScreenSize.y),0,0);
    OUT.TexCoord0 = TexCoord + off;
    return OUT;
}
...
float x_texel_incr() { return TexelStride / ScreenSize.x; }
float y_texel_incr() { return TexelStride / ScreenSize.y; }
