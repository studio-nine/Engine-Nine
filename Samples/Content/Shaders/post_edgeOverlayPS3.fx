/*********************************************************************NVMH3****
File:  $Id: //sw/devtools/FXComposer1.6/SDK/MEDIA/HLSL/post_edgeOverlayPS3.fx#1 $
...
Same as scene_edgeDetect, but with the kernel values "hand-cooked" for
	efficiency -- and NINE texcoords using PS3
...
struct EdgeVertexOutput
{
    ...
    QUAD_REAL2 UV11		: TEXCOORD4;
    QUAD_REAL2 UV12		: TEXCOORD5;
    QUAD_REAL2 UV20		: TEXCOORD6;
    QUAD_REAL2 UV21		: TEXCOORD7;
    QUAD_REAL2 UV22		: TEXCOORD8;
};
...
QUAD_REAL4 edgeOverlayPS(EdgeVertexOutput IN,
	...
	QUAD_REAL result = 1;
	if (dist>T2) { result = 0; }
	CC = tex2D(ColorMap,IN.UV11) * QUAD_REAL4(result.xxx,1.0);
	return CC;
}
...
> {
    ...
    > {
		...
		PixelShader = compile ps_3_0 edgeOverlayPS(SceneSampler,(Threshhold*Threshhold));
    }
}
