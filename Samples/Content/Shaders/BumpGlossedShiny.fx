/*********************************************************************NVMH3****
File:  $Id: //sw/devtools/FXComposer1.6/SDK/MEDIA/HLSL/BumpGlossedShiny.fx#1 $
...
Comments:
    Bumpy, shiny, dielectric, textured, with quadratic-falloff lights
...
half4 mainPS(vertexOutput IN) : COLOR
{
    ...
    half3 bumps = Bumpy * (tex2D(normalSampler,IN.TexCoord.xy).xyz * 2 - 1);
    ...
    half4 reflColor = Kr * texCUBE(envSampler,reflVect);
