...
{
    class PassThroughSceneManager : ISceneManager
    {
        ...
        public void FindAll(ref Microsoft.Xna.Framework.BoundingFrustum boundingFrustum, ICollection<ISpatialQueryable> result)
        {
