...
namespace Nine.Graphics
{
    public class TopDownEditorCamera : ICamera
    {
        ...
        public TopDownEditorCamera(IServiceProvider services) : this(services, 50, MathHelper.PiOver2 * 0.6f) { }

        public TopDownEditorCamera(IServiceProvider services, float radius, float pitch)
        {
