...
namespace Nine.Graphics.Landscape
{
    ...
    public sealed class TerrainPatch : IDisposable
    {
        ...
        private static VertexPositionNormalTangentTexture[] vertexPool;
        ...
        internal void Invalidate()
        {
            ...
            if (vertexPool == null || vertexPool.Length < VertexCount)
                vertexPool = new VertexPositionNormalTangentTexture[VertexCount];
            ...
            VertexBuffer.SetData<VertexPositionNormalTangentTexture>(vertexPool, 0, VertexCount);
