namespace Nine.Graphics.UI.Media
{
    ...
    public class SpecialBrush : Brush
    {
        ...
        internal SpecialBrush()
        {

        }

        public SpecialBrush(Texture2D texture)
            : this(texture, new Rectangle(0, 0, texture.Width, texture.Height))
        {

        }

        public SpecialBrush(Texture2D texture, Rectangle sourceArea)
        {
        ...
        private void Build(BoundingRectangle bound)
        {
