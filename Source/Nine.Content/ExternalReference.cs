namespace Nine
{
    ...
    public class ExternalReference : MarkupExtension
    {
        ...
        public override object ProvideValue(IServiceProvider serviceProvider)
        {
            ...
            var destinationTypeProvider = serviceProvider.TryGetService<IDestinationTypeProvider>();
            if (destinationTypeProvider != null)
            {
                ...
                catch
                {
                    try
                    {
                        var provideValueTarget = serviceProvider.TryGetService<IProvideValueTarget>();
