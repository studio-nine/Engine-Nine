...
namespace Isles
{
    ...
    public class PickEngine : IPickable
    {
        ...
        public object Pick(Ray ray, out float? distance)
        {
            ...
            foreach (Entry e in objects)
            {
                ...
                if (e.Object is BoundingBox?)
                    ...
                    point = Intersects(e.Object as IGeometry, pickRay, e.Sphere);
        ...
        /// </summary>
        public static float? Intersects(IGeometry geometry, Ray ray, BoundingSphere? sphere)
        {
            ...
            for (int i = 0; i < geometry.Indices.Count; i += 3)
            {
                ...
                Intersects(ref ray, ref v1, ref v2, ref v3, out point);
        ...
        /// </summary>
        public static void Intersects(ref Ray ray,
                                          ref Vector3 vertex1,
                                          ref Vector3 vertex2,
        ...
        /// </summary>
        public static Ray TransformRay(Ray input, Matrix transform)
        {
