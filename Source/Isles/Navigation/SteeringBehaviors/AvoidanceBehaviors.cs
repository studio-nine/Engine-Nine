...
//
//=============================================================================
namespace Isles.Navigation.SteeringBehaviors
{
    ...
    public sealed class ObstacleAvoidanceBehavior : ISteeringBehavior
    {
        ...
        public ISpacialObjectManager Obstacles { get; set; }
        ...
        public Vector3 CalculateForce(GameTime gameTime, IMovable movingEntity)
        {
            ...
            foreach (object o in Obstacles.GetNearbyObjects(movingEntity.Position, detector))
            {
                ...
                Vector2 localOffset;// = obstacle.Center - movingEntity.Position;
