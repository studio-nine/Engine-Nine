...
namespace CustomToolTemplate
{
    ...
    public abstract class CustomToolBase : IVsSingleFileGenerator, IObjectWithSite
    {
        public CustomToolBase()
        {
            ...
            ProgressFacadeProvider
                = ivsgen => new GenerationProgressFacade(ivsgen);
        }

        /// <summary>
        /// ProjectItemProvider improves testability for the 
        /// IVsSingleFileGenerator.Generate method
        /// </summary>
        public Func<Microsoft.VisualStudio.OLE.Interop.IServiceProvider, ProjectItem> ProjectItemProvider { get; set; }

        /// <summary>
        /// ProgressFacadeProvider improves testability for the
        /// IVsSingleFileGenerator.Generate method
        /// </summary>
        public Func<IVsGeneratorProgress, GenerationProgressFacade> ProgressFacadeProvider { get; set; }
        ...
        public event CompletedGenerationHandler OnCompletedGeneration;
