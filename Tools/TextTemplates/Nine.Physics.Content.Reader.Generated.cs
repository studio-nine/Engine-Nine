...
namespace Nine.Physics
{
    ...
    partial class BodyReader : Microsoft.Xna.Framework.Content.ContentTypeReader<Nine.Physics.Body>
    {
        protected override Nine.Physics.Body Read(Microsoft.Xna.Framework.Content.ContentReader input, Nine.Physics.Body existingInstance)
        {
            if (existingInstance == null)
                existingInstance = new Body();
