...
namespace Nine.Test
{
    ...
    public class TriangleTest
    {
        ...
        public void IntersectsTest()
        {
            ...
            Assert.AreEqual<bool>(true, target.Intersects(Vector3.One, Vector3.UnitZ * -0.1f));
            Assert.AreEqual<bool>(false, target.Intersects(Vector3.One, Vector3.UnitZ * 0.1f));
            ...
            Assert.AreEqual<bool>(true, target.Intersects(box.Min, box.Min + Vector3.UnitZ * 4));
