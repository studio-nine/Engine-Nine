...
namespace Nine.Graphics.ScreenEffects
{
    ...
    public sealed class BloomEffect : IScreenEffect, IDisposable
    {
        ...
        public void Draw(Texture2D texture)
        {
            ...
            GraphicsDevice.DrawSprite(texture, SamplerState.LinearClamp, Color.White, extract);
            ...
            GraphicsDevice.DrawSprite(intermediate, SamplerState.LinearClamp, Color.White, blur);
            ...
            GraphicsDevice.DrawSprite(texture, SamplerState.LinearClamp, Color.White, combine);
