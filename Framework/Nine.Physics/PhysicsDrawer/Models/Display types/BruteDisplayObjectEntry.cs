namespace BEPUphysicsDrawer.Models
{
    ...
    internal class BruteDisplayObjectEntry
    {
        ...
        internal BruteDisplayObjectEntry(BruteModelDrawer drawer, ModelDisplayObjectBase displayObject)
        {
            ...
            vertexBuffer = new VertexBuffer(displayObject.Drawer.GraphicsDevice, typeof (VertexPositionNormalTexture), vertices.Length, BufferUsage.WriteOnly);
            indexBuffer = new IndexBuffer(displayObject.Drawer.GraphicsDevice, IndexElementSize.SixteenBits, indices.Length, BufferUsage.WriteOnly);
