namespace BEPUphysicsDrawer.Models
{
    ...
    /// </summary>
    class InstancedModelDrawer : ModelDrawer
    {
        ...
        public InstancedModelDrawer(GraphicsDevice graphics)
            : base(graphics)
        {
            instancingEffect = new Nine.Physics.PhysicsDrawer.Models.InstancedEffect(graphics);
        ...
        protected override void Add(ModelDisplayObjectBase displayObject)
        {
            ...
            var batchToAdd = new ModelDisplayObjectBatch(GraphicsDevice);
