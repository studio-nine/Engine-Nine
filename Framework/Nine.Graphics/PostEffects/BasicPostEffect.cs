...
namespace Nine.Graphics.PostEffects
{
    ...
    /// </summary>
    public class BasicPostEffect : IPostEffect, IUpdateable, IEffectTexture
    {
        /// <summary>
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class ScreenEffectCollection : Collection<IPostEffect>
    {
        internal ScreenEffectCollection() { }

        public void Add(Effect effect)
        {
            Add(new BasicPostEffect() { Effect = effect });
        }

        public void Add(Effect effect, float renderTargetScale)
        {
            Add(new BasicPostEffect() { Effect = effect, RenderTargetScale = renderTargetScale });
        }
    }
}
