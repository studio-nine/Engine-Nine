...
namespace Nine.Graphics.PostEffects
{
    ...
    public class ChainedPostEffect : IPostEffect, IUpdateable, IEffectTexture
    {
        /// <summary>
        ...
        internal List<object> EffectsSerializer
        {
            ...
            set
            {
                ...
                {
                    if (value[i] is IPostEffect)
                        Effects.Add(value[i] as IPostEffect);
