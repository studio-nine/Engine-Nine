...
namespace Nine.Graphics.ParticleEffects
{
    ...
    public class ParticleEffect : Transformable, ISpatialQueryable, IDrawableObject, IUpdateable, IDisposable
    {
        ...
        /// This method can only be called from the main rendering thread.
        /// </summary>
        ...
        private void Update()
        {
            lock (syncRoot)
            {
                ...
                // Block drawing thread when the update is too far behind
                //if (Interlocked.Decrement(ref numFramesBehind) < maxFrameDelays)
                //  ;
            }
        }
        #endregion
        ...
        #region Threading
        /// <summary>
        /// Gets or sets the maximum number of frames for the update frame to catch up with the drawing frame
        /// when particle systems are async.
        /// The default value is 2 frames.
        /// </summary>
        public static int MaxFrameDelays
        {
            get { return maxFrameDelays; }
            set { maxFrameDelays = value; }
        }
        // TODO: Implement this
        private static int maxFrameDelays = 2;

        /// <summary>
        /// Gets or sets a value indicating whether particle effects will be updated asynchronously.
        /// </summary>
