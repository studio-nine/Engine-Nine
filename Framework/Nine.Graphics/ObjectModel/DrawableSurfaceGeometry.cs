...
namespace Nine.Graphics.ObjectModel
{
    ...
    public sealed class DrawableSurfaceGeometry : IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DrawableSurfaceGeometry"/> class.
        /// </summary>
        /// <param name="graphics">The graphics.</param>
        /// <param name="patchSegmentCount">The patch segment count.</param>
        public DrawableSurfaceGeometry(GraphicsDevice graphics, int patchSegmentCount)
        {
            if (graphics == null)
        ...
        {
            DrawableSurfaceGeometry result = null;
            WeakReference<DrawableSurfaceGeometry> value;
            ...
            result = (DrawableSurfaceGeometry)Activator.CreateInstance(typeof(DrawableSurfaceGeometry), graphics, patchSegmentCount);
            value = new WeakReference<DrawableSurfaceGeometry>(result);
            resourceDictionary.Add(new KeyValuePair<GraphicsDevice, int>(graphics, patchSegmentCount), value);

            return result;
        }
        static Dictionary<KeyValuePair<GraphicsDevice, int>, WeakReference<DrawableSurfaceGeometry>> resourceDictionary = new Dictionary<KeyValuePair<GraphicsDevice, int>, WeakReference<DrawableSurfaceGeometry>>();
