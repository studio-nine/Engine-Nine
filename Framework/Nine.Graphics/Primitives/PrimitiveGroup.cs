...
namespace Nine.Graphics.Primitives
{
    ...
    public class PrimitiveGroup : IDrawableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Provides an optimization hint to skip comparision between primitives.
        /// </summary>
        ...
        /// </summary>
        public PrimitiveGroup(GraphicsDevice graphics) : this(graphics, 32, 32768)
        {
        ...
        /// Initializes a new instance of the <see cref="PrimitiveGroup"/> class.
        /// </summary>
        public PrimitiveGroup(GraphicsDevice graphics, int initialBufferCapacity, int maxBufferSizePerPrimitive)
        {
            if (graphics == null)
            ...
            this.Material = new BasicMaterial(graphics) { LightingEnabled = false };
