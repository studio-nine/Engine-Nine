...
namespace Nine.Content.Pipeline.Graphics
{
    ...
    /// </summary>
    [ContentTypeWriter]
    internal class ImageListWriter : ContentTypeWriter<ImageListContent>
    {
        /// <summary>
        ...
        {
            return typeof(Nine.Graphics.ImageListReader).AssemblyQualifiedName;
        }
        ...
        {
            return typeof(Nine.Graphics.ImageList).AssemblyQualifiedName;
        }
    }
}
