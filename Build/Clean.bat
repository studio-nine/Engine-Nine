...
for /f "delims=" %%i in ('dir /b /a-d /s "cachefile-*.txt"') do (del /s "%%i")
for /f "delims=" %%i in ('dir /b /a-d /s "*.suo"') do (del /ah /s "%%i")
for /f "delims=" %%i in ('dir /b /a-d /s "*.suo"') do (del /s "%%i")
for /f "delims=" %%i in ('dir /b /a-d /s "*.sdf"') do (del /s "%%i")
for /f "delims=" %%i in ('dir /b /a-d /s "*.opensdf"') do (del /s "%%i")
for /f "delims=" %%i in ('dir /b /a-d /s "*.orig"') do (del /s "%%i")
...
for /f "delims=" %%i in ('dir /b /a-d /s "*.sdf"') do (del /s "%%i")
for /f "delims=" %%i in ('dir /b /a-d /s "*.xap"') do (del /s "%%i")
