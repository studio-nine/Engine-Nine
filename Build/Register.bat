...
reg add "HKLM\SOFTWARE\Microsoft\Microsoft SDKs\Silverlight for WindowsPhone\v4.0\AssemblyFoldersEx\Engine Nine" /f /ve /d "%CD%\References\Windows Phone"
...
reg add "HKLM\SOFTWARE\Wow6432Node\Microsoft\Microsoft SDKs\Silverlight for WindowsPhone\v4.0\AssemblyFoldersEx\Engine Nine" /f /ve /d "%CD%\References\Windows Phone"
