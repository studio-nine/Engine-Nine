...
reg query HKLM\SOFTWARE\Microsoft\VCSExpress\10.0\Generators\{FAE04EC1-301F-11d3-BF4B-00C04F79EFBC}
...
reg query HKLM\SOFTWARE\Microsoft\VisualStudio\10.0\Generators\{FAE04EC1-301F-11d3-BF4B-00C04F79EFBC}
if %ERRORLEVEL% == 1 goto endreg
...
reg query HKLM\SOFTWARE\Microsoft\VPDExpress\10.0\Generators\{FAE04EC1-301F-11d3-BF4B-00C04F79EFBC}
if %ERRORLEVEL% == 1 goto endreg
...
reg query HKLM\SOFTWARE\Wow6432Node\Microsoft\VCSExpress\10.0\Generators\{FAE04EC1-301F-11d3-BF4B-00C04F79EFBC}
if %ERRORLEVEL% == 1 goto endreg
...
reg query HKLM\SOFTWARE\Wow6432Node\Microsoft\VisualStudio\10.0\Generators\{FAE04EC1-301F-11d3-BF4B-00C04F79EFBC}
if %ERRORLEVEL% == 1 goto endreg
...
reg query HKLM\SOFTWARE\Wow6432Node\Microsoft\VPDExpress\10.0\Generators\{FAE04EC1-301F-11d3-BF4B-00C04F79EFBC}
if %ERRORLEVEL% == 1 goto endreg
